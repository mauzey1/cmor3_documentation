...
* {: style="color:green"}Fortran: 0 
* {: style="color:blue"} C: 0 
* {: style="color:coral"}Python: None 
...
* {: style="color:green"} a negative integer if an error is encountered; otherwise returns 0.
* {: style="color:blue"} 0 upon success
* {: style="color:coral"} True if the attribute exists, False otherwise.
...
* {: style="color:green"}Fortran: a positive integer if an error is encountered; otherwise returns a negative integer (the “handle”) uniquely identifying the grid. 

* {: style="color:blue"}C: 0 upon success. 

* {: style="color:coral"}Python: upon success, a positive integer (the “handle”) uniquely identifying the axis, or if an error is encountered an exception is raised. 
...
* {: style="color:green"}Fortran: a negative integer if an error is encountered; otherwise returns a positive integer (the “handle”) uniquely identifying the z-factor.

* {: style="color:blue"}C: 0 upon success.

* {: style="color:coral"}Python: upon success, a positive integer (the “handle”) uniquely identifying the z-factor, or if an error is encountered an exception is raised.
...
* {: style="color:green"}Fortran: a negative integer if an error is encountered; otherwise returns a positive integer (the “handle”) uniquely identifying the variable.

* {: style="color:blue"}C: 0 upon success.

* {: style="color:coral"}Python: upon success, a positive integer (the “handle”) uniquely identifying the variable, or if an error is encountered an exception is raised.
...
* {: style="color:coral"}Python: The attribute value
...
* {: style="color:green"}Fortran: nothing it is a subroutine

* {: style="color:blue"}C: 0 upon success or 1 if the filed is a fixed field

* {: style="color:coral"}Python: the full path to the output file
...
* {: style="color:green"}Fortran: 0 upon success

* {: style="color:blue"}C: 0 upon success

* {: style="color:coral"}Python: None if file_name=False, or the name of the file if file_name=True and a var_id is passed as an argument.
